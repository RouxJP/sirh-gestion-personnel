      ...
      <ul class="navbar-nav mr-auto">
        <nav class="navbar navbar-light bg-light">
          <a class="navbar-brand" href="#">
            <img src="logo-collaborateur.jpg" width="30" height="30" alt="">
          </a>
        </nav>
  ...
  <main>
    <div class="container">
      <div class="row">
        ...
        <div class="col-4">
          <a href="creer.html" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Ajouter un nouveau collaborateur</a>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-4">
          ...
          <label class="form-check-label" for="defaultCheck1">
            Voir les collaborateurs par défault
          </label>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-2">
          ...
          <a href="editer.html" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Editer</a>
        </div>
